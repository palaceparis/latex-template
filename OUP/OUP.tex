...
\begin{figure}[p]
\includegraphics[width=1\linewidth]{OUP_files/figure-latex/fig1-1} \caption{This is the first figure.}\label{fig:fig1}
\end{figure}
...
\begin{figure}[p]
\includegraphics[width=1\linewidth]{OUP_files/figure-latex/fig2-1} \caption{This is the second figure.}\label{fig:fig2}
\end{figure}
