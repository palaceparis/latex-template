...
\ccsdesc[100]{Replace ccsdesc macro with valid one, e.g., `Information systems
\(\rightarrow\) Question answering'}
...
%optional
\relatedversion{A full version of the paper is available at https://\ldots{}}

%optional
\supplement{See code at https://github.com/.. and data at https://doi.org/\ldots{}}
...
\addcontentsline{toc}{subsection}{Minimum requirements}
...
\addcontentsline{toc}{subsection}{Mandatory metadata macros}
...
\addcontentsline{toc}{paragraph}{Please do not \ldots }
...
\cite{DBLP:conf/focs/HopcroftPV75}, orci nibh sodales quam, id egestas
